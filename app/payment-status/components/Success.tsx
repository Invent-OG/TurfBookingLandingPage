...
export default function Success({ bookingData }: any) {
  ...
  return (
    <div className="h-full flex flex-col justify-center items-center bg-green-600 p-5 text-white ">
      <div className="max-w-md w-full text-center space-y-6">
        <CheckCircle className="w-16 h-16 text-white mx-auto" />
        <h2 className="text-3xl font-bold">Booking Confirmed! 🎉</h2>
        <p className="text-lg">Your booking has been successfully confirmed.</p>
